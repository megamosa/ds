...
class Data extends AbstractHelper
{
    ...
    // Order Note Settings
    private const XML_PATH_SHOW_ORDER_NOTE = 'magoarab_easyorder/form_fields/show_order_note';
    private const XML_PATH_ORDER_NOTE_LABEL = 'magoarab_easyorder/form_fields/order_note_label';
    private const XML_PATH_ORDER_NOTE_PLACEHOLDER = 'magoarab_easyorder/form_fields/order_note_placeholder';
    private const XML_PATH_ORDER_NOTE_REQUIRED = 'magoarab_easyorder/form_fields/order_note_required';
    private const XML_PATH_ORDER_NOTE_POSITION = 'magoarab_easyorder/form_fields/order_note_position';
    
    // Coupon Code Settings
    private const XML_PATH_ENABLE_COUPON_CODE = 'magoarab_easyorder/form_fields/enable_coupon_code';
    private const XML_PATH_COUPON_FIELD_LABEL = 'magoarab_easyorder/form_fields/coupon_field_label';
    private const XML_PATH_COUPON_FIELD_PLACEHOLDER = 'magoarab_easyorder/form_fields/coupon_field_placeholder';
    private const XML_PATH_COUPON_FIELD_POSITION = 'magoarab_easyorder/form_fields/coupon_field_position';
    ...
    public function getDefaultShippingPrice(?int $storeId = null): float
    {
        ...
        // CRITICAL DEBUG: Log the exact value being returned
        $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
        $logger = $objectManager->get(\Psr\Log\LoggerInterface::class);
        $logger->error('CRITICAL DEBUG: getDefaultShippingPrice called', [
            'raw_value' => $value,
            'float_value' => $floatValue,
            'store_id' => $storeId,
            'config_path' => self::XML_PATH_DEFAULT_SHIPPING_PRICE,
    ...
    {
        // CRITICAL FIX: Do NOT use flatrate/price as fallback - this was causing the 50!
        $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
        $logger = $objectManager->get(\Psr\Log\LoggerInterface::class);
        $logger->info('FIXED: getFallbackShippingPrice called - NOT using flatrate/price', [
            'store_id' => $storeId
        ]);
...
public function isPostcodeFieldRequired(?int $storeId = null): bool
{
    ...
    // =======================================================================
    // ORDER NOTE CONFIGURATION METHODS
    // =======================================================================

    /**
     * Check if order note field should be displayed
     */
    public function isOrderNoteEnabled(?int $storeId = null): bool
    {
        return $this->scopeConfig->isSetFlag(
            self::XML_PATH_SHOW_ORDER_NOTE,
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
    ...
    /**
     * Get order note field label
     */
    public function getOrderNoteLabel(?int $storeId = null): string
    {
        $label = $this->scopeConfig->getValue(
            self::XML_PATH_ORDER_NOTE_LABEL,
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
        return $label ?: __('Special Instructions');
    }

    /**
     * Get order note field placeholder
     */
    public function getOrderNotePlaceholder(?int $storeId = null): string
    {
        $placeholder = $this->scopeConfig->getValue(
            self::XML_PATH_ORDER_NOTE_PLACEHOLDER,
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
        return $placeholder ?: __('Any special instructions for your order?');
    }

    /**
     * Check if order note field is required
     */
    public function isOrderNoteRequired(?int $storeId = null): bool
    {
        return $this->scopeConfig->isSetFlag(
            self::XML_PATH_ORDER_NOTE_REQUIRED,
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
    ...
    /**
     * Get order note field position
     */
    public function getOrderNotePosition(?int $storeId = null): string
    {
        $position = $this->scopeConfig->getValue(
            self::XML_PATH_ORDER_NOTE_POSITION,
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
        return $position ?: 'before_submit';
    }

    /**
     * Get order note field configuration as array
     */
    public function getOrderNoteConfig(?int $storeId = null): array
    {
        return [
            'enabled' => $this->isOrderNoteEnabled($storeId),
            'label' => $this->getOrderNoteLabel($storeId),
            'placeholder' => $this->getOrderNotePlaceholder($storeId),
            'required' => $this->isOrderNoteRequired($storeId),
            'position' => $this->getOrderNotePosition($storeId)
        ];
    }

    // =======================================================================
    // COUPON CODE CONFIGURATION METHODS
    // =======================================================================

    /**
     * Check if coupon code field should be displayed
     */
    public function isCouponCodeEnabled(?int $storeId = null): bool
    {
        return $this->scopeConfig->isSetFlag(
            self::XML_PATH_ENABLE_COUPON_CODE,
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
    ...
    /**
     * Get coupon field label
     */
    public function getCouponFieldLabel(?int $storeId = null): string
    {
        $label = $this->scopeConfig->getValue(
            self::XML_PATH_COUPON_FIELD_LABEL,
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
        return $label ?: __('Discount Coupon');
    }

    /**
     * Get coupon field placeholder
     */
    public function getCouponFieldPlaceholder(?int $storeId = null): string
    {
        $placeholder = $this->scopeConfig->getValue(
            self::XML_PATH_COUPON_FIELD_PLACEHOLDER,
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
        return $placeholder ?: __('Enter your coupon code (optional)');
    }

    /**
     * Get coupon field position
     */
    public function getCouponFieldPosition(?int $storeId = null): string
    {
        $position = $this->scopeConfig->getValue(
            self::XML_PATH_COUPON_FIELD_POSITION,
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
        return $position ?: 'after_payment';
    }

    /**
     * Get coupon field configuration as array
     */
    public function getCouponConfig(?int $storeId = null): array
    {
        return [
            'enabled' => $this->isCouponCodeEnabled($storeId),
            'label' => $this->getCouponFieldLabel($storeId),
            'placeholder' => $this->getCouponFieldPlaceholder($storeId),
            'position' => $this->getCouponFieldPosition($storeId)
        ];
    }
}