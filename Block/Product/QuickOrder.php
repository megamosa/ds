...
class QuickOrder extends Template
{
     ...
     * @return bool
     */
    public function isOrderNoteEnabled(): bool
    {
        return $this->helperData->isOrderNoteEnabled();
    }
     ...
     * @return string
     */
    public function getOrderNoteLabel(): string
    {
        return $this->helperData->getOrderNoteLabel();
    }
     ...
     * @return string
     */
    public function getOrderNotePlaceholder(): string
    {
        return $this->helperData->getOrderNotePlaceholder();
    }
     ...
     * @return bool
     */
    public function isOrderNoteRequired(): bool
    {
        return $this->helperData->isOrderNoteRequired();
    }
     ...
     * @return string
     */
    public function getOrderNotePosition(): string
    {
        return $this->helperData->getOrderNotePosition();
    }

    /**
     * Get complete order note configuration
     *
     * @return array
     */
    public function getOrderNoteConfig(): array
    {
        return $this->helperData->getOrderNoteConfig();
    }

    /**
     * Check if order note should be displayed at specific position
     *
     * @param string $position
     * @return bool
     */
    public function shouldShowOrderNoteAt(string $position): bool
    {
        return $this->isOrderNoteEnabled() && $this->getOrderNotePosition() === $position;
    }
     ...
     * @return bool
     */
    public function isCouponCodeEnabled(): bool
    {
        return $this->helperData->isCouponCodeEnabled();
    }
     ...
     * @return string
     */
    public function getCouponFieldLabel(): string
    {
        return $this->helperData->getCouponFieldLabel();
    }
     ...
     * @return string
     */
    public function getCouponFieldPlaceholder(): string
    {
        return $this->helperData->getCouponFieldPlaceholder();
    }
     ...
     * @return string
     */
    public function getCouponFieldPosition(): string
    {
        return $this->helperData->getCouponFieldPosition();
    }

    /**
     * Get complete coupon configuration
     *
     * @return array
     */
    public function getCouponConfig(): array
    {
        return $this->helperData->getCouponConfig();
    }

    /**
     * Check if coupon field should be displayed at specific position
     *
     * @param string $position
     * @return bool
     */
    public function shouldShowCouponAt(string $position): bool
    {
        return $this->isCouponCodeEnabled() && $this->getCouponFieldPosition() === $position;
    }
}